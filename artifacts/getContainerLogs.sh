...
function getLogs(){
	...
	docker logs peer0.org3.example.com &> peer0_org3.txt
	docker logs peer1.org3.example.com &> peer1_org3.txt
	docker logs ca_peerOrg1 &> ca_peerOrg1.txt
	docker logs ca_peerOrg2 &> ca_peerOrg2.txt
	docker logs ca_peerOrg3 &> ca_peerOrg3.txt
